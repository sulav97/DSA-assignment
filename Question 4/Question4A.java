/*
        Quesion 4        
        a)
        You are given a 2D grid representing a Question4A in a virtual game world. The grid is of size m x n and consists of
        ...
        As you explore the Question4A, you may come across hidden keys represented by lowercase letters. To unlock a door
        ...
        alphabet in the Question4A. This means that there is exactly one key for each door, and one door for each key. The letters
